...
router.get(
  "/profile/:shop_id",
  Setting.getShopProfile
);

router.get(
  "/bank-account/:shop_id",
  Setting.getBankAccount
);

router.get(
  "/services/:shop_id",
  Setting.getShopServices
);

router.get(
  "/verify-status/:shop_id",
  Setting.checkShopVerified
);

router.post(
  "/services",
  Setting.saveShopServices
);
