...
// import { ShoppingBag, Trash2, X, AlertCircle } from "lucide-react";
...
//     // 4. ถ้าเลือกวันปัจจุบัน เวลาต้อง >= เวลาตอนนี้
...
//             </div>
//             <div>
//               <p className="text-xs text-slate-500">{cartItems.length} รายการที่เลือกไว้</p>
...
//             className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl shadow-md shadow-blue-500/25 transition cursor-pointer"
//           >
...
//       {/* Pop-up Drawer สรุปตะกร้า */}
//       {isOpen && (
//         <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-900/60 backdrop-blur-xs">
//           <div className="bg-white w-full max-w-lg rounded-t-3xl sm:rounded-3xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden">
//             <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
//               <div className="flex items-center gap-2">
//                 <ShoppingBag className="w-5 h-5 text-blue-600" />
//                 <h3 className="font-bold text-base text-slate-900">ตะกร้าสินค้า ({shop?.shop_name})</h3>
//               </div>
//               <div className="flex items-center gap-2">
//                 <button
//                   type="button"
...
//                 }`}
//               >
//                 {shop?.is_open === false ? "ร้านปิดทำการ (ไม่สามารถสั่งได้)" : "ไปที่หน้าชำระเงิน →"}
//               </button>
//             </div>
//           </div>
//         </div>
